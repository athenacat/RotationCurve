...
for gal_ID in FILE_IDS:
    ...
    best_fit_iso = parameterfit_iso(param,param_outputs['rho_bulge'],param_outputs['R_bulge'],param_outputs['Sigma_disk'],param_outputs['R_disk'],scale,shape,maps['vmasked'],maps['ivarmasked'],map_mask)