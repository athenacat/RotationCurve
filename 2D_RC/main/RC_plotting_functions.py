...
def plot_rot_curve(mHa_vel,
    ...
    for i in range(len(r)):
        if r[i] > 0:
            ...
            if halo_model == 'Isothermal':
                v_h[i] = halo_vel_iso(r[i] * 1000, 10**best_fit_values[4], best_fit_values[5] * 1000)
                ...
                v_h[i] = halo_vel_NFW(r[i] * 1000, 10**best_fit_values[4], best_fit_values[5] * 1000)
                v[i] = vel_tot_NFW(r[i], [best_fit_values[0], best_fit_values[1], best_fit_values[2], best_fit_values[3],
                                   10**best_fit_values[4], best_fit_values[5]])
               
            elif halo_model == 'Burkert':
                v_h[i] = halo_vel_Bur(r[i] * 1000, 10**best_fit_values[4], best_fit_values[5] * 1000)
            ...
            if halo_model == 'Isothermal':
                v_h[i] = -halo_vel_iso(np.abs(r[i] * 1000), 10**best_fit_values[4], best_fit_values[5] * 1000)
                v[i] = -vel_tot_iso(np.abs(r[i]), [best_fit_values[0], best_fit_values[1], best_fit_values[2],
                                    best_fit_values[3], 10**best_fit_values[4], best_fit_values[5]])
            elif halo_model == 'NFW':
                ...
                v_h[i] = -halo_vel_Bur(np.abs(r[i] * 1000), 10**best_fit_values[4], best_fit_values[5] * 1000)
