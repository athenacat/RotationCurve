...
DRP_index = {}
index = []
failed_gals = vstack([failed_object_table[failed_object_table['visual code']==1],failed_object_table[failed_object_table['visual code']==3.1]])
FILE_IDS = failed_gals['plateifu']
...
for gal_ID in FILE_IDS:
    ...
    ################################################
        ...
        print(gal_ID,"Fit flag: ",out_table['fit flag'][i_gal], flush=True)
